          ...
          <div className="mx-auto max-w-6xl">
            <div className="flex flex-col items-center">
              ...
              <h1 className="text-center text-3xl font-semibold text-heading md:max-w-4xl lg:text-5xl xl:text-6xl">
                Welcome to SINEX INSTITUTE OF TECHNOLOGY(SIT), for aspiring business and IT leaders!
              </h1>
              <p className="mt-6 max-w-3xl text-xl">
                Strive for excellence, Innovate with creativity, Transform through continuous growth.
              </p>
        ...
        <section className="text-gray-600 body-font">
          <div className="container px-5 pt-24 mx-auto">
            <div className="flex flex-col text-center w-full mb-20">
              <h2 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Strive for Innovative Transformations: Embrace Change with Purpose</h2>
              <p className="lg:w-2/3 mx-auto leading-relaxed text-lg">Embark on a transformative journey where the spirit of innovation meets the determination to strive for excellence. In this dynamic space, we challenge norms and invite you to join a community driven by the desire to continually evolve and improve. Together, let's unlock new possibilities, embrace change as a catalyst, and elevate every aspect of your life. It's more than a journey, it's a commitment to transforming your potential into a powerful force for positive change.</p>
            </div>
            ...
            <div className="grid gap-6 px-4 sm:px-0 sm:grid-cols-2 md:grid-cols-3 ">
              <div className="group relative rounded-3xl  space-y-6 overflow-hidden">
                ...
                <div className="absolute bottom-0 inset-x-0 h-max mt-auto px-8 py-6 bg-gray-800 dark:bg-white translate-y-24 transition duration-300 ease-in-out group-hover:translate-y-0">
                  <div>
                    <h4 className="text-xl font-semibold dark:text-gray-700 text-white">Md Shabab Anwer</h4>
                    <span className="block text-sm text-gray-500">CEO-Founder</span>
                  </div>
                  <p className="mt-8 text-gray-300 dark:text-gray-600">Lets take a step towards bright future.</p>
                </div>
              ...
              <div className="group relative rounded-3xl  space-y-6 overflow-hidden">
                ...
                <div className="absolute bottom-0 inset-x-0 h-max mt-auto px-8 py-6 bg-gray-800 dark:bg-white translate-y-24 transition duration-300 ease-in-out group-hover:translate-y-0">
                  <div>
                    <h4 className="text-xl font-semibold dark:text-gray-700 text-white">Anas Ansari</h4>
                    <span className="block text-sm text-gray-500">Co-Founder & CTO</span>
                  </div>
                  <p className="mt-8 text-gray-300 dark:text-gray-600">Helping the future of youngers.</p>
                </div>
              ...
              <div className="group relative rounded-3xl  space-y-6 overflow-hidden">
                ...
                <div className="absolute bottom-0 inset-x-0 h-max mt-auto px-8 py-6 bg-gray-800 dark:bg-white translate-y-24 transition duration-300 ease-in-out group-hover:translate-y-0">
                  <div>
                    <h4 className="text-xl font-semibold dark:text-gray-700 text-white">Neyaz Ahmed</h4>
                    <span className="block text-sm text-gray-500">General Manager</span>
                  </div>
                  <p className="mt-8 text-gray-300 dark:text-gray-600">Motivate the youth of our country.</p>
                </div>
