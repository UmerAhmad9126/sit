...
import Logo from "../resources/images/logo-without background.png";
      ...
      <div className="bg-gray-200 ">
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          <Link className="w-1/4 flex title-font font-medium items-center md:justify-start justify-center text-gray-500">
            ...
            <img className="scale-120 pt-2 w-16 " src={Logo} alt="logo" />

            {/* <span className="text-3xl text-gray-400 hover:text-blue-500 transition-all duration-500 hidden lg:block">SIT</span> */}
          </Link>
          <p className="w-1/2 text-lg text-center text-gray-400 sm:ml-6 sm:mt-0 mt-4">
            © {Date().slice(10, 15)} SIT —
            <a
              href="https://twitter.com/ax_shabab"
